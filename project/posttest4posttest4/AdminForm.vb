...
Public Class AdminForm
    ...
    Private Sub aturdaftar(ByVal cari As String)
        ...
        If RD.HasRows Then
            While RD.Read
                ...
                ' pfood
                ' 
                If Not RD(7).ToString = "" Then
                    Try
                        If System.IO.File.Exists(RD(7)) Then
                            Dim filePath As String = Module1.RD(7).ToString()
                ...
                Else
                    pfood.Image = My.Resources.Resources.food
                End If
                pfood.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage

                pfood.Location = New Point(22, 23)
                pfood.Name = "pfood"
                pfood.Size = New Size(101, 80)
                pfood.TabIndex = 1
                pfood.TabStop = False
                ' 
                ' nama
    ...
    Private Sub editmakanan(sender As Object, e As EventArgs)
        ...
        Dim nn As PictureBox = New PictureBox
        nn = clickedPanel.Controls(9)
        PictureBox3.Image = nn.Image
        Dim brt() As String = parts(1).Split("g"c)
        txtberat.Text = brt(0)
    End Sub


    Private Sub FormmClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Login.Close()
        Registrasi.Close()
        Cek.Close()
        Beranda.Close()
    ...
    Sub aturuser(ByVal s As String)
        ...
        If RD.HasRows Then
            While RD.Read
                ...
                user1.Location = New Point(50, 10 + (133 * index))
                user1.Name = "user1"
                ...
                If Not RD(11).ToString = "" Then
                    Try
                        If System.IO.File.Exists(RD(11)) Then
                            Dim filePath As String = Module1.RD(11).ToString()
                            Dim image As Image = Image.FromFile(filePath)
                            pp1.Image = image
                        Else
                ...
                user2.Location = New Point(212, 10 + (133 * index))
                user2.Name = "user2"
                ...
                user3.Location = New Point(381, 10 + (133 * index))
                user3.Name = "user3"
    ...
    Private Sub AdminForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        aturchart2()
        ambilAkun()
        tAktivity.AutoCompleteMode = AutoCompleteMode.None
        tAktivity.AutoCompleteSource = AutoCompleteSource.ListItems
        tJenis.AutoCompleteMode = AutoCompleteMode.None
        tJenis.AutoCompleteSource = AutoCompleteSource.ListItems
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Not selectid = -1 Then
            Dim hps As String = "delete from makanan where id = '" & selectid & "'"
        ...
        If RD.HasRows Then
            ...
            If Not RD(11).ToString = "" Then
                Try
                    ...
                    Else
                        PictureBox2.Image = My.Resources.login
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        ...
        If openFileDialog.ShowDialog() = DialogResult.OK Then
            ...
            ''MsgBox(selectedImagePath)
            If Not selectid = -1 Then
                Dim ubah As String = "update makanan set img = '" & selectedImagePath & "' where id = '" & selectid & "' "
                CMD = New MySqlCommand(ubah, CONN)
                CMD.ExecuteNonQuery()
            Else
                MsgBox("tes")
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        If openFileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Dim ubah As String = "update akun set img = '" & selectedImagePath & "' where id = '" & Login.idLogin & "' "
            CMD = New MySqlCommand(ubah, CONN)
            CMD.ExecuteNonQuery()
        End If
        ambilAkun()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ''MsgBox(selectedImagePath)
        Dim Simpan As String = "insert into makanan(nama, kalori, lemak, protein, karbohidrat, berat, img) values('" & txtnama.Text & "', '" & txtkalori.Text & "', '" & txtlemak.Text & "', '" & txtprotein.Text & "', '" & txtkarbo.Text & "', '" & txtberat.Text & "', '" & selectedImagePath & "')"
    ...
    Private Sub AdminForm_Closing(sender As Object, e As CancelEventArgs) Handles MyBase.Closing
        Registrasi.Close()
        Login.Close()

    End Sub

    Private Sub txtprotein_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtprotein.KeyPress
        If Not (IsNumeric(e.KeyChar) Or e.KeyChar = vbBack) Then
            e.Handled = True
        End If
    End Sub

    Private Sub txtkarbo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtkarbo.KeyPress
        If Not (IsNumeric(e.KeyChar) Or e.KeyChar = vbBack) Then
            e.Handled = True
        End If
    End Sub
