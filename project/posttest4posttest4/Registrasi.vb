...
Public Class Registrasi
    ...
    Private Sub Registrasi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        taktivitas.AutoCompleteMode = AutoCompleteMode.None
        taktivitas.AutoCompleteSource = AutoCompleteSource.ListItems
        kelamin.AutoCompleteMode = AutoCompleteMode.None
        kelamin.AutoCompleteSource = AutoCompleteSource.ListItems
    End Sub
    ...
    Private Sub btnregis_Click(sender As Object, e As EventArgs) Handles btnregis.Click
        If cekKosong() = 1 Then
            ...
            If kelamin.SelectedIndex = 0 Then
