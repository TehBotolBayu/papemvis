...
Public Class UserForm
    ...
    Private Sub aturDashboard()
        ...
        If Module1.RD.HasRows Then
            While Module1.RD.Read
                If Not tglasupan = hariini.ToString("yy-MM-dd") Then
        ...
        CMD = New MySqlCommand("SELECT nutrisi.id, makanan.nama, makanan.kalori, makanan.lemak, makanan.protein, makanan.karbohidrat, nutrisi.porsi, makanan.img FROM nutrisi JOIN makanan WHERE nutrisi.idmakanan = makanan.id AND nutrisi.tanggal = '" & tglasupan & "' AND nutrisi.idakun = '" & Login.idLogin & "'", CONN)
        Module1.RD = CMD.ExecuteReader
        Dim ii As Integer = 0
    ...
    Private Sub makananfavorit()
        CMD = New MySqlCommand("SELECT makanan.nama, SUM(nutrisi.porsi) As total_porsi FROM nutrisi INNER JOIN makanan ON nutrisi.idmakanan = makanan.id WHERE nutrisi.idakun = '" & Login.idLogin & "' GROUP BY makanan.nama ORDER BY total_porsi DESC", CONN)
    ...
    Private Sub Timer4_Tick(sender As Object, e As EventArgs) Handles Timer4.Tick
        If paneltambah.Location.X > PanelAsupan.Width - 250 Then
    ...
    Private Sub PictureBox8_Click(sender As Object, e As EventArgs) Handles PictureBox8.Click
        ...
        CMD = New MySqlCommand("SELECT nutrisi.id, makanan.nama, makanan.kalori, makanan.lemak, makanan.protein, makanan.karbohidrat, nutrisi.porsi, makanan.img FROM nutrisi JOIN makanan WHERE nutrisi.id = '" & selected & "'", CONN)
        Module1.RD = CMD.ExecuteReader
        RD.Read()
